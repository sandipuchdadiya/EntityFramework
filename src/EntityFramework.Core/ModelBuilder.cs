...
namespace Microsoft.Data.Entity
{
    ...
    public class ModelBuilder : IModelBuilder<ModelBuilder>
    {
        ...
        /// <summary>
        ///     <para>
        ///         Performs configuration of a given entity in the model. If the entity is not already part of the model, it will 
        ///         be added to the model.
        ///     </para>
        ///     <para>
        ///         This overload allows configuration of the entity to be done in line in the method call rather than being chained 
        ///         after a call to <see cref="Entity{TEntity}()"/>. This allows additional configuration at the model level to be 
        ///         chained after configuration for the entity.
        ///     </para>
        /// </summary>
        /// <typeparam name="TEntity"> The type of entity to be configured. </typeparam>
        ...
        /// <summary>
        ///     Excludes the given entity from the model. This method is typically used to remove types from 
        ...
        public class EntityBuilder : IEntityBuilder<EntityBuilder>
        {
            ...
            /// <summary>
            ///     The internal builder being used to configure the entity. 
            /// </summary>
            ...
            /// <summary>
            ///     The model that the entity belongs to.
            /// </summary>
            Model IMetadataBuilder<EntityType, EntityBuilder>.Model => Builder.ModelBuilder.Metadata;

            /// <summary>
            ///     Adds or updates an annotation on the entity. If an annotation with the key specified in <paramref name="annotation"/>
            ///     already exists it's value will be updated.
            /// </summary>
            /// <param name="annotation"> The key of the annotation to be added or updated. </param>
            /// <param name="value"> The value to be stored in the annotation. </param>
            ...
            /// <summary>
            ///     Sets the properties that make up the primary key for this entity.
            /// </summary>
            ...
            /// <summary>
            ///     Excludes the given property from the entity. This method is typically used to remove properties from 
            ///     the entity that were added by convention.
            /// </summary>
            /// <param name="propertyName"> The name of then property to be removed from the entity. </param>
            ...
            /// <summary>
            ///     <para>
            ///         Configures a relationship where this entity has a reference that points
            ...
            ///     </para>
            /// </summary>
            /// <param name="relatedType"> The entity that this relationship targets. </param>
            /// <param name="reference"> 
            ///     The name of the reference navigation property on this entity that represents the relationship. If no
            ...
            /// <summary>
            ///     <para>
            ///         Configures a relationship where this entity has a collection that contains
            ...
            ///     </para>
            /// </summary>
            /// <param name="relatedEntityType"> The entity that this relationship targets. </param>
            /// <param name="collection"> 
            ///     The name of the collection navigation property on this entity that represents the relationship. If no
            ///     property is specified, the relationship will be configured without a navigation property on this end.
            /// </param>
            /// <returns> An object that can be used to configure the relationship. </returns>
            ...
            ///     </para>
            /// </summary>
            /// <param name="relatedEntityTypeName"> The name of the entity that this relationship targets. </param>
            /// <param name="reference"> 
            ///     The name of the reference navigation property on this entity that represents the relationship. If no
            ///     property is specified, the relationship will be configured without a navigation property on this end.
            /// </param>
            ...
            public class PropertyBuilder : IPropertyBuilder<PropertyBuilder>
            {
                ...
                ///     the data store. If it has changed, an exception will be thrown and the changes will not be applied to the
                ///     data store.
                /// </summary>
                ...
                // TODO Add info about value generators when we have API sorted out for adding/customizing them
                /// <summary>
                ...
                // TODO Define exactly what this does and doc it
            ...
            public class IndexBuilder : IIndexBuilder<IndexBuilder>
            {
                ...
                /// <summary>
                ///     Configures whether this index is unique (i.e. the value(s) for each entity instance must be unique).
                /// </summary>
            ...
            public class ReferenceNavigationBuilder
            {
                ...
                ///     </para>
                /// </summary>
                /// <param name="relatedEntityType"> The entity that the reference points to. </param>
                /// <param name="reference"> 
                ...
                /// <summary>
                ///     Gets or sets the entity that the reference points to.
                /// </summary>
            ...
            ///     <para>
            ///         Provides a simple API for configuring a relationship where configuration began on
            ///         an end of the relationship with a collection that contains instances of another entity.
            ///     </para>
            ///     <para>
            ///         Instances of this class are returned from methods when using the <see cref="ModelBuilder"/> API 
            ///         and it is not designed to be directly constructed in your application code.
            ...
            public class OneToManyBuilder : IOneToManyBuilder<OneToManyBuilder>
            {
                ...
                ///     </para>
                ///     <para>
                ///         If the specified property name(s) do not exist on the entity then a new shadow state property(s)
                ...
                ///         entity. If they do not match, new shadow state properties that form a unique index will be 
                ///         added to the principal entity to serve as the reference key. 
                ///     </para>
                ///     <para>
                ///         If multiple foreign key properties are specified, the order of foreign key properties should match the 
                ///         order that the primary key properties were configured in.
                ///     </para>
                /// </summary>
                ...
                /// <summary>
                ///     <para>
                ///         Configures the unique property(s) that this relationship targets.
                ///     </para>
                ///     <para>
                ///         If multiple reference key properties are specified, the order of reference key properties should match the 
                ///         order that the primary key or unique index properties were configured on the principal entity.
                ///     </para>
                /// </summary>
            ...
            public class OneToOneBuilder : IOneToOneBuilder<OneToOneBuilder>
            {
                ...
                ///     The entity that is the dependent in this relationship (the type that has the foreign key properties).
                /// </param>
                /// <param name="foreignKeyPropertyNames"> 
                ///     The name(s) of the foreign key property(s). 
                /// </param>
                ...
                ///     The entity that is the principal in this relationship (the type
                ...
                ///     The name of the entity that is the dependent in this relationship (the type that has the foreign key properties).
                /// </param>
                /// <param name="foreignKeyPropertyNames"> 
                ///     The name(s) of the foreign key property(s). 
                /// </param>
                ...
                ///     The name of the entity that is the principal in this relationship (the type
                ///     that has the reference key properties).
                /// </param>
                /// <param name="keyPropertyNames"> The name(s) of the reference key property(s). </param>
                /// <returns> The same builder instance so that multiple configuration calls can be chained. </returns>
            ...
            where TEntity : class
        {
            /// <summary>
            ///     <para>
            ///         Initializes a new instance of the <see cref="EntityBuilder{TEntity}"/> class to configure a given entity.
            ///     </para>
            ///     <para>
            ///         Instances of this class are returned from methods when using the <see cref="ModelBuilder"/> API 
            ///         and it is not designed to be directly constructed in your application code.
            ...
            ///     </para>
            /// </summary>
            /// <typeparam name="TRelatedEntity"> The entity that this relationship targets. </typeparam>
            /// <param name="reference"> 
            ///     A lambda expression representing the reference navigation property on this entity that represents the 
            ...
            /// <typeparam name="TRelatedEntity"> The entity that this relationship targets. </typeparam>
            /// <param name="collection"> 
            ///     A lambda expression representing the collection navigation property on this entity that represents the 
